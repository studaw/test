<div style="margin-bottom: 2px;" class="col-xs-12">
    <div class="col-xs-6" style="padding-left: 2px;">
        <h2 style="color: #C74743;padding: 0;margin: 2px;">个人博客分享</h2>
        <small style="color: #808080;">&emsp;- 生活 工作 -</small>
    </div>
    <#--    <div class="col-xs-6">-->
    <#--        <span class="btn btn-mini btn-danger pull-right" style="margin-top: 10px;">-->
    <#--            <a style="text-decoration:none;color: #ffffff;" href="/app/app.apk"><i class="icon-android"></i> 安卓APP</a>-->
    <#--        </span>-->
    <#--    </div>-->
</div>
...
<#--                    <li><a href="/donation"><i class="icon-yen"></i> 请站长喝可乐</a></li>-->
