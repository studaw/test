        ...
        <#if adTypeList?? && adTypeList?size gt 0>
            <#list adTypeList as adType>
                <li class="list-group-item">
                    <a href="/hzh/ad/list?adTypeId=${(adType.adTypeId)!}">
                        ${(adType.adTypeTitle)!}
                    </a>
...
<div class="col-sm-9 img-thumbnail">
    <div class="panel col-sm-12">
        <div class="panel-body">
            <button onclick="adAdd()" type="button" class="btn btn-mini">添加</button>
            ...
            <div class="panel col-sm-12">
                <div class="panel-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="adImgUrl" class="col-sm-2">广告图片：</label>
                            <div class="col-sm-4">
                                <input type="test" class="form-control" name="adImgUrl" id="adImgUrl"
                                       placeholder="图片地址">
                            </div>
...
<script>
    ...
    function adAddOrUpdate() {
        ...
        if (!checkNotNull(adId) && !checkNotNull(adImgUrl)) {
            zuiMsg("请选择广告图片");
            return;
        }
        ...
        // formData.append("file", $("#adImgUrl")[0].files[0]);
